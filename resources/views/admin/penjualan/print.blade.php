            ...
            <page size="A4">
				<div class="">
					<div class="panel-body">
						<h4 class="text-center">LAPORAN PENJUALAN <br>{{strtoupper(env('APP_NAME'))}}
                        </h4>
                        <br>
                            ...
                            <table class="table table-bordered" id="datawidth" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align:center; vertical-align: middle;">Kode Transaksi</th>
                                        <th style="text-align:center; vertical-align: middle;">Tanggal</th>
                                        <th style="text-align:center; vertical-align: middle;" width="15%">Pembeli</th>
                                        <th style="text-align:center; vertical-align: middle;">Qty</th>
                                        <th style="text-align:center; vertical-align: middle;" width="15%">Jumlah</th>
                                    </tr>
                                </thead>
                                ...
                                <tr>
                                    ...
                                    <td>{{$row->user}}</td>
                                    <td>{{$row->qty}}</td>
                                    <td><div style="display: flex;flex-wrap: nowrap;align-content: center;justify-content: space-between;" class="px-2"><span>Rp. </span><span>{{number_format($row->jumlah)}}</span></div></td>
                                    <?php $total = $total + $row->qty;?>
                                    <?php $total1 = $total1 + $row->jumlah;?>
                                </tr>
                                @endforeach
                                </tbody>
                                <tfoot>
                                    <tr>
                                        ...
                                        <th><div style="display: flex;flex-wrap: nowrap;align-content: center;justify-content: space-between;" class="px-2"><span>Rp. </span><span>{{number_format($total1)}}</span></div></td></th>
                                    </tr>
                                </tfoot>
                            </table>
			            </div>
